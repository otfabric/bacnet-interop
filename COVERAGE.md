...
| Image | Peer / aid | Pin |
|---|---|---|
| `ghcr.io/otfabric/bacnet-interop-bacnet-stack` | [bacnet-stack](https://github.com/bacnet-stack/bacnet-stack) | `bacnet-stack-1.3.8` |
...
| bacnet-stack | 1.3.8 | segmentation | Segmented ComplexACK | Stack TSM aborts with segmentation-not-supported rather than segmenting | Assert Abort; segmented reassembly covered by BACpypes3 + BACnet4J |
