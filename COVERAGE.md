...
Adapter version: `v0.4.1` · Fixture revision: `device-baseline-v2`
...
| Who-Has / I-Have | ✓ | ✓ | ✓ | Object-identifier and object-name forms |
...
| WritePropertyMultiple (WPM) | ✓ | ✓ | ✓ | BACpypes3 is **adapter-shim** (`do_WritePropertyMultipleRequest` → `write_property`); bacnet-stack / BACnet4J upstream-native |
...
| Segmented confirmed-request receive | — | ✓ | — | BACpypes3 accepts segmented WPM send; BACnet4J rejects segmented confirmed receive |
...
- Peer adapters construct device + AV-1 + BV-1 from that JSON; bacnet-stack and BACnet4J also serve TrendLog. BACpypes3 skips TrendLog (no server ReadRange).
